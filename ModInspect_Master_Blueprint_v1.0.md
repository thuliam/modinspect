...
ModInspect data must be separated into five domains.
...
14. **Pure PHP MVC remains the baseline; do not copy BYB's framework/worker stack without need.**
15. **Do not build enterprise infrastructure before the 20-product / 500-observation POC passes.**
...
```text
             ...
             │                   │                    │
             ▼                   ▼                    ▼
       ROUTINE SEARCH       DEEP RESEARCH       MARKET SIGNALS
        COLLECTORS              SCOUT           / SOCIAL LISTEN
             │                   │                    │
             └──────────────┬────┴───────────────┬────┘
                            ▼                    │
                       CANDIDATE POOL            │
